//package com.starv.tvindex.util.tips;
//
...
//
///**
// * 图片翻转显示 http://www.open-open.com/lib/view/open1325749794953.html
// *
// * */
...
//        mCirclePaint.setColor(getResources().getColor(R.color.white_a));
//        //mCirclePaint.setShadowLayer(radius, 3, 3, 0xffFFffFF);
//        if (myShape != null) {
//            RectF oval = new RectF();
//            switch (myShape) {
//                case CIRCULAR://圆形
//                    temp.drawCircle(center[0], center[1], radius+20, mCirclePaint);//绘制圆形
//                    break;
//                case ELLIPSE://椭圆
//                    //RectF对象
