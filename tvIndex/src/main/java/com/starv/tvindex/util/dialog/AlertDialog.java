...
public class AlertDialog {
	...
	public AlertDialog setMsg(String msg,int pos,boolean flag) {
		showMsg = true;
		txt_msg.setGravity(pos);
		if(flag){
			//m_obj_warning.setVisibility(View.VISIBLE);
		}else{
			//m_obj_warning.setVisibility(View.GONE);
		}
		String html = "";
		if ("".equals(msg)) {
			txt_msg.setText("内容");
