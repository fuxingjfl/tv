...
// * 我的节目页面
// */
//public class LocalMyprogramFragment extends BaseSwipeRefreshFragment{
//
//
//
//
...
//        return Constant.myProgram_url + "?" + "regionId="+SharePreferenceUtil.getInstance(getActivity()).get(Constant.localData_areaId);
//    }
//}
