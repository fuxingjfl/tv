...
//
//
////        Log.i("test","RealtimeDataFragment initview");
...
//            //http://192.168.10.70:8080/weizhi/localxhb/test.html
//            m_obj_webviewUtil.setView(m_obj_webview, getActivity(), Constant.realDataUrl);
//        }
//        m_obj_webviewUtil.setLister(new WebViewUtil.IgetJsonData() {
//            @Override
//            public void responseJson(String url,String title) {
//                //获取url
//                Intent intent = new Intent();
//                intent.putExtra("loadurl", Constant.homeUrl + url);
